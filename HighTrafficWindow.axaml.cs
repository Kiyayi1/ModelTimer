...
public partial class HighTrafficWindow : Window
{
    ...
    private void AddHeaderRow()
    {
        ...
        var headers = new[] { "User", "Site", "Spend Habits", "Triggers", "Notes", "Action" };
    ...
    private void AddDataRow(CrmRecord item, int rowIndex)
    {
        ...
        var cells = new[] { item.User, item.Site, item.Habits, item.Triggers, item.Notes };
